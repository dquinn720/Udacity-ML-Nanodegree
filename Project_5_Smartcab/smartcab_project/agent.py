...
class LearningAgent(Agent):
    ...
    def build_state(self):
        ...
        state = (inputs['oncoming'], inputs['left']=='forward', inputs['light'], waypoint)
    ...
    def get_maxQ(self, state):
        ...
        maxQ = self.Q[str(state)][str(max(self.Q[str(state)], key=lambda key: self.Q[str(state)][key]))]
    ...
    def learn(self, state, action, reward):
        ...
        if self.learning == True:
            ...
            self.Q[str(state)][str(action)]=reward*self.alpha + currentQ*(1-self.alpha)
